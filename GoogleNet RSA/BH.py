...
for mk in range(len(type_of_image)):
    ...
    for i in range(len(slice_names)):
        sliceF_x_image = pd.read_pickle(
            r'C:\Users\Asus\Desktop\Project\GoogleNet\CNN Slices Flattened by Image as pickle\\' + str(i).zfill(3) + '_' +
            slice_names[
                i] + '_for_all_images' + '.p')
    ...
    scipy.io.savemat(
        'C:/Users/Asus/Desktop/Project/GoogleNet/RDM Comparisons B mats/' + str(k + 1) + '_RDM_comparison_' +
        type_of_image[
            k] + '.mat',
...
comparison_mats_directory = "C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons B mats\\"
comparison_mats = []
...
for l in range(len(comparison_mats)):
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons B Plots\\' + str(l + 1) + '_' + type_of_image[
            l] + '.png',
        dpi=100)
    plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons B Plots\\Combined_HF.png',
    dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons MAX Plots\\MAX_BH_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons Best Layer Plots\\Best_Layer_BH_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
