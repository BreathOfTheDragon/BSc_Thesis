...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons B Plots\\Combined_LF.png',
    dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons MAX Plots\\MAX_BL_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\GoogleNet\\RDM Comparisons Best Layer Plots\\Best_Layer_BL_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
