...
for i in range(len(slice_names)):
    sliceF_x_image = pd.read_pickle(
        r'E:\Project\GoogleNet\CNN Slices Flattened by Image as pickle\\' + str(i) + '_' + slice_names[
            i] + '_for_all_images' + '.p')
    sliceF_x_image = sliceF_x_image.transpose()
    ...
    print(i)
scipy.io.savemat(
    'E:/Project/GoogleNet/RDM Comparison mats/' + str(k + 1) + '_RDM_comparison_' + type_of_image[k] + '.mat',
