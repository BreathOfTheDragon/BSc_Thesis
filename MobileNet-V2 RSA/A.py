...
slice_names = np.append(slice_names, np.array(models.feature_extraction.get_graph_node_names(mobilenet)[0]))
...
for mk in range(len(type_of_image)):
    ...
    for i in range(len(slice_names)):
        sliceF_x_image = pd.read_pickle(
            r'C:\Users\Asus\Desktop\Project\MobileNet-V2\CNN Slices Flattened by Image as pickle\\' + str(i).zfill(
                3) + '_' +
            slice_names[
                i] + '_for_all_images' + '.p')
    ...
    scipy.io.savemat(
        'C:/Users/Asus/Desktop/Project/MobileNet-V2/RDM Comparisons A mats/' + str(k + 1) + '_RDM_comparison_' +
        type_of_image[
            k] + '.mat',
...
comparison_mats_directory = "C:\\Users\\Asus\\Desktop\\Project\\MobileNet-V2\\RDM Comparisons A mats\\"
comparison_mats = []
...
for l in range(len(comparison_mats)):
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\MobileNet-V2\\RDM Comparisons A Plots\\' + str(l + 1) + '_' + type_of_image[
            l] + '.png',
        dpi=100)
    plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\MobileNet-V2\\RDM Comparisons A Plots\\Combined.png',
    dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\MobileNet-V2\\RDM Comparisons MAX Plots\\MAX_A_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\MobileNet-V2\\RDM Comparisons Best Layer Plots\\Best_Layer_A_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
