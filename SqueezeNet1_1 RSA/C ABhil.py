...
re101 = models.resnet101(pretrained=True)
slice_names = np.array([])  # a list of the names of all slices of the network
slice_names = np.append(slice_names, np.array(models.feature_extraction.get_graph_node_names(re101)[0]))
...
for mk in range(len(type_of_image)):
    ...
    scipy.io.savemat(
        'C:/Users/Asus/Desktop/Project/ResNet101/RDM Comparisons BAHIL mats/' + str(k + 1) + '_RDM_comparison_' +
        type_of_image[
            k] + '.mat',
