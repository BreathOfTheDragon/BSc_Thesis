...
comparison_mats_directory = "E:\\Project\\ResNet18\\RDM Comparisons A mats\\"
comparison_mats = []
...
for l in range(len(comparison_mats)):
    ...
    plt.draw()
    plt.savefig(
        'E:\\Project\\ResNet18\\RDM Comparisons A Plots\\' + str(l + 1) + '_' + type_of_image[l] + '.png',
        dpi=100)
    plt.close()
...
plt.draw()
plt.savefig(
    'E:\\Project\\ResNet18\\RDM Comparisons A Plots\\Combined.png',
    dpi=100)
plt.close()
...
plt.draw()
plt.savefig('E:\\Project\\ResNet18\\RDM Comparisons MAX Plots\\MAX_A_Types.png',
            dpi=100)
plt.close()
plt.figure(figsize=(25, 25))
plt.ylim(0, 69)
...
plt.draw()
plt.savefig('E:\\Project\\ResNet18\\RDM Comparisons Best Layer Plots\\Best_Layer_A_Types.png',
            dpi=100)
