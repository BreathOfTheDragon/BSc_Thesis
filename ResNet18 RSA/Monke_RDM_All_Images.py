...
monkey_matrix = monke_brain_matrix[77:83]
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\ResNet18\\RDMs Monke all images plot 2\\RDM_Monke_HIL_Images_mycalc.png',
    dpi=300)
plt.close()
# </editor-fold>
...
# plt.draw()
# plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\ResNet18\\RDMs Monke all images plot 2\\RDM_Monke_HIL_images_toolbox.png',
#             dpi=300)
# plt.close()
# # </editor-fold>
