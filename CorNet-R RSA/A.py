...
for i in range(len(slice_names)):
    sliceF_x_image = pd.read_pickle(
        r'C:\Users\Asus\Desktop\Project\CorNet-R\CNN Slices Flattened by Image as pickle\\' + str(i+1).zfill(2) + '_' +
        slice_names[
            i] + '_for_all_images' + '.p')
    ...
    print(i)
scipy.io.savemat(
    'C:/Users/Asus/Desktop/Project/CorNet-R/RDM Comparisons A mats/' + str(k + 1) + '_RDM_comparison_' + type_of_image[
        k] + '.mat',
