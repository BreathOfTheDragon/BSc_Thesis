...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\CorNet-S 2\\RDM Comparisons B Plots\\Combined_LF.png',
    dpi=100)
plt.close()
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\CorNet-S 2\\RDM Comparisons MAX Plots\\MAX_BL_Types.png',
            dpi=100)
plt.close()
plt.figure(figsize=(25, 25))
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\CorNet-S 2\\RDM Comparisons Best Layer Plots\\Best_Layer_BL_Types.png',
            dpi=100)
