...
for i in range(len(slice_names)):
    sliceF_x_image = pd.read_pickle(
        r'C:\Users\Asus\Desktop\Project\AlexNet\CNN Slices Flattened by Image as pickle\\' + str(i).zfill(3) + '_' + slice_names[
            i] + '_for_all_images' + '.p')
    ...
    print(i)
scipy.io.savemat(
    'C:/Users/Asus/Desktop/Project/AlexNet/RDM Comparison mats/' + str(k + 1) + '_RDM_comparison_' + type_of_image[k] + '.mat',
