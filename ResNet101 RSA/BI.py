...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\ResNet101\\RDM Comparisons B Plots\\Combined_IF.png',
    dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\ResNet101\\RDM Comparisons MAX Plots\\MAX_BI_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\ResNet101\\RDM Comparisons Best Layer Plots\\Best_Layer_BI_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
