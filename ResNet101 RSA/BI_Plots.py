...
slice_names = np.append(slice_names, np.array(models.feature_extraction.get_graph_node_names(resnet101)[0]))

comparison_mats_directory = "E:\\Project\\ResNet101\\RDM Comparisons B mats\\"
comparison_mats = []
...
for l in range(len(comparison_mats)):
    ...
    plt.draw()
    plt.savefig(
        'E:\\Project\\ResNet101\\RDM Comparisons B Plots\\' + str(l + 1) + '_' + type_of_image[l] + '.png',
        dpi=100)
    plt.close()
...
plt.draw()
plt.savefig(
    'E:\\Project\\ResNet101\\RDM Comparisons B Plots\\Combined_IF.png',
    dpi=100)
plt.close()
...
plt.draw()
plt.savefig('E:\\Project\\ResNet101\\RDM Comparisons MAX Plots\\MAX_BI_Types.png',
            dpi=100)
plt.close()
plt.figure(figsize=(25, 25))
plt.ylim(0, 69)
...
plt.draw()
plt.savefig('E:\\Project\\ResNet101\\RDM Comparisons Best Layer Plots\\Best_Layer_BI_Types.png',
            dpi=100)
