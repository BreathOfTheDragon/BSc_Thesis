...
print(ax1)
accuracies = []
train_input_BH = np.transpose(neuron_output[:, 77:89])
train_input_BI = np.transpose(neuron_output[:, 104:116])
train_input_BL = np.transpose(neuron_output[:, 131:143])

test_input_BH = np.transpose(neuron_output[:, 77:89])
test_input_BI = np.transpose(neuron_output[:, 104:116])
test_input_BL = np.transpose(neuron_output[:, 131:143])
