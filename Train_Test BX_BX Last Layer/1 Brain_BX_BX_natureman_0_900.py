...
train_output = ['natural', 'natural', 'natural', 'natural', 'natural', 'natural', 'manmade', 'manmade', 'manmade',
                'manmade', 'manmade', 'manmade']
test_output = ['natural', 'natural', 'natural', 'natural', 'natural', 'natural', 'manmade', 'manmade', 'manmade',
               'manmade', 'manmade', 'manmade']
...
for kkk in range(len(neuron_output)):
    ...
    train_input_BH = np.transpose(
        neuron_output[kkk]["neurons_stacked_averaged_for_" + str(0 + 5 * kkk) + "_to_" + str(49 + 5 * kkk)][:, 89:101])
    train_input_BI = np.transpose(
        neuron_output[kkk]["neurons_stacked_averaged_for_" + str(0 + 5 * kkk) + "_to_" + str(49 + 5 * kkk)][:, 116:128])
    train_input_BL = np.transpose(
        neuron_output[kkk]["neurons_stacked_averaged_for_" + str(0 + 5 * kkk) + "_to_" + str(49 + 5 * kkk)][:, 143:155])
...
for lll in range(len(labels)):
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\Comparing Models Last Layer\\BX_BX\\natureman\\Brain BX_BX_Accuracy 0_900\\'
        + train_test_labels[
            lll] + '_' +
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\Comparing Models Last Layer\\BX_BX\\natureman\\Brain BX_BX_Accuracy 0_900\\' + 'BX_BX_' +
    model_names + ' Accuracy.png',
    dpi=300)
plt.close()
# </editor-fold>
