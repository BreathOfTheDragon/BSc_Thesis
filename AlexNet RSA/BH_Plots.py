...
plt.draw()
plt.savefig(
    'E:\\Project\\AlexNet\\RDM Comparisons B Plots\\Combined_HF.png',
    dpi=100)
plt.close()
...
plt.draw()
plt.savefig('E:\\Project\\AlexNet\\RDM Comparisons MAX Plots\\MAX_BH_Types.png',
            dpi=100)
plt.close()
plt.figure(figsize=(25, 25))
plt.ylim(0, 69)
...
plt.draw()
plt.savefig('E:\\Project\\AlexNet\\RDM Comparisons Best Layer Plots\\Best_Layer_BH_Types.png',
            dpi=100)
