...
for mk in range(len(type_of_image)):
    ...
    scipy.io.savemat(
        'C:/Users/Asus/Desktop/Project/AlexNet/RDM Comparisons A mats/' + str(k + 1) + '_RDM_comparison_' +
        type_of_image[
            k] + '.mat',
...
comparison_mats_directory = "C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons A mats\\"
comparison_mats = []
...
for l in range(len(comparison_mats)):
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons A Plots\\' + str(l + 1) + '_' + type_of_image[
            l] + '.png',
        dpi=100)
    plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons A Plots\\Combined.png',
    dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons MAX Plots\\MAX_A_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons Best Layer Plots\\Best_Layer_A_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
