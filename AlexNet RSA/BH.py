...
# This code imports the data of brain neurons (352 neurons) for type BH categories (human_face , inanimate & ...)
# also imports data of all neurons (each layer has many neurons) of all layers of a NN for the same type BH categories
...
# in the end , plots the correlation of brain for type BH categories and each of the NN layers for type BH categories
...
type_of_image = ['Human_Face_HF', 'Animal_Face_HF', 'Human_Body_HF', 'Animal_Body_HF', 'Natural_HF', 'Man_Made_HF',
                 'Face_HF', 'Body_HF', 'Animate_HF', 'Inanimate_HF', 'All_HF']
...
# <editor-fold desc="plotting type BH correlations between brain and each NN layer , for each type BH category , each in 1 plot">
...
# <editor-fold desc="plotting type BH correlations between brain and each NN layer , for each type BH category , all in 1 plot">
plt.figure(figsize=(20, 20))
plt.yticks(fontsize=20)
plt.ylim(-1.0, 1.0)
plt.xticks(fontsize=10, rotation=90)
...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons B Plots\\Combined_HF.png',
    dpi=100)
plt.close()
# </editor-fold>

# <editor-fold desc="plotting which layer has the highest correlation for each type BH category , aka best layer">
max_comparisons = []
max_indices = []
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons MAX Plots\\MAX_BH_Types.png',
            dpi=100)
plt.close()
# </editor-fold>

# <editor-fold desc="plotting what is the correlation value of the best layer for each type BH category , aka max correlation">
plt.figure(figsize=(25, 25))
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons Best Layer Plots\\Best_Layer_BH_Types.png',
            dpi=100)
plt.close()
# </editor-fold>
