...
for g in glist:
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons MISC Plots\\' + str(kkk + 1) + '_' +
        type_of_image2[
            kkk] + '.png',
        dpi=100)
    plt.close()
...
for g in glist:
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDM Comparisons MISC Plots\\' + str(kkk + 7) + '_' +
        type_of_image3[
            kkk] + '.png',
        dpi=100)
    plt.close()
