...
plt.draw()
plt.savefig(
    'C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDMs Monke all images plot\\RDM_Monke_HIL_Images_mycalc.png',
    dpi=300)
plt.close()
# </editor-fold>
...
plt.draw()
plt.savefig('C:\\Users\\Asus\\Desktop\\Project\\AlexNet\\RDMs Monke all images plot\\RDM_Monke_HIL_images_toolbox.png',
            dpi=300)
plt.close()
# </editor-fold>
