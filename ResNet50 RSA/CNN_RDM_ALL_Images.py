...
for k in range(len(slice_names)):
    sliceF_x_image = pd.read_pickle(
        r'C:\Users\Asus\Desktop\Project\ResNet50\CNN Slices Flattened by Image as pickle\\' + str(k).zfill(3) + '_' +
        slice_names[
            k] + '_for_all_images' + '.p')
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\ResNet50\\RDMs CNN all images plot\\' + str(k).zfill(
            3) + '_RDM_' +
...
for w in range(len(slice_names)):
    sliceF_x_image = pd.read_pickle(
        r'C:\Users\Asus\Desktop\Project\ResNet50\CNN Slices Flattened by Image as pickle\\' + str(w).zfill(3) + '_' +
        slice_names[
            w] + '_for_all_images' + '.p')
    sliceF_x_image = sliceF_x_image.transpose()
    sliceF_x_image = sliceF_x_image[74:155]
    ...
    plt.draw()
    plt.savefig(
        'C:\\Users\\Asus\\Desktop\\Project\\ResNet50\\RDMs CNN all images plot\\' + str(w).zfill(3) + '_RDM_' +
